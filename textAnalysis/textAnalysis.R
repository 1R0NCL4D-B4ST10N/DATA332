...
wordcloud(words = issue_wordcloud$Issue, freq = issue_wordcloud$n, min.freq = 50, random.order = FALSE, colors = brewer.pal(8, "Dark2"))
ggsave("images/issue_word_cloud.png")

# Save processed data
write.csv(bing_sentiment, "bing_sentiment.csv", row.names = FALSE)
write.csv(nrc_sentiment, "nrc_sentiment.csv", row.names = FALSE)
write.csv(sentiment_by_product, "sentiment_by_product.csv", row.names = FALSE)
